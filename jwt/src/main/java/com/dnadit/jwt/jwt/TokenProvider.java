...
public class TokenProvider implements InitializingBean {
    ...
    public TokenProvider(
            ...
            @Value("${jwt.token-validity-in-seconds}") long tokenValidityInSeconds) { // @Value는 application.yml에서 설정했던 것들.
        this.secret = secret;
    ...
    // 토큰에 담겨있는 정보를 이용해 Authentication 객체를 리턴하는 메소드 추가
